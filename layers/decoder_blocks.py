...
class Layer(BaseLayer):
    ...
    def __init__(self, kernel_size, in_channels, out_channels, padding='same', **kwargs):
        ...
        self.conv1 = Conv2DTranspose(in_channels, kernel_size=kernel_size, padding=padding)
        self.gn1 = BatchNormalization(axis=-1)
        self.conv2 = Conv2DTranspose(out_channels, kernel_size=kernel_size, padding=padding, strides=(2, 2))
