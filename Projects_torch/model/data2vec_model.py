...
from Projects_tensorflow.layers.masking import Masking
from Projects_tensorflow.layers.ffn import FFN
from Projects_tensorflow.layers import TransformerEncoder
from Projects_tensorflow.layers.archive.conv_feature_encoder import ConvFeatureExtractionModel
...
class Data2VecModel(tf.keras.Model):
    ...
    #     """Build a new train_task instance."""
    #
    #     return cls(cfg)
    #
    ...
    #
    #     with torch.no_grad():
    #         self.ema.train_task.eval()
    #
    #         if self.cfg.ema_transformer_only:
    #             y, layer_results = self.ema.train_task.extract_features(
    ...
    #             }
    #         else:
    #             y = self.ema.train_task.extract_features(
    #                 source=source,
